...
|------|------|:---:|:---:|
| **ePhaZ** | 胞外 PHB/PHA 解聚酶（EC 3.1.1.75/76） | 38,275 | 27,574 |
| **iPhaZ** | 胞内 PHA 解聚酶（含 Cys 型/Ser 型/周质） | 32,846 | 25,873 |
| **OH** | 3HB 寡聚体水解酶（EC 3.1.1.22） | 1,470 | 1,449 |
| **ArchPhaZ_hydrolase** | 古菌经典 PHB 解聚酶家族酯酶 | 1,292 | 1,236 |
| **ArchPhaZ_patatin** | 古菌 patatin 样（PhaZh1 型，基因组级 PhaC 共现过滤后） | **1,372** | **620** |

**核心解聚酶 tier1 合计 ~75,000 条 / ~57,000 基因组（28% 基因组）**
**其中古菌 PHB 降解基因：~2,664 序列 / ~1,856 基因组（hydrolase + patatin）**

### 2.2 古菌 patatin 型解聚酶分布（基因组级 PhaC 共现过滤后，PhaZh1 型）
